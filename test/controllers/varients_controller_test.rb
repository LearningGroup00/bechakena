...
class VarientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create varient" do
    assert_difference("Varient.count") do
      post varients_url, params: { varient: { color: @varient.color, size: @varient.size, sku: @varient.sku } }
    end
  ...
  test "should update varient" do
    patch varient_url(@varient), params: { varient: { color: @varient.color, size: @varient.size, sku: @varient.sku } }
