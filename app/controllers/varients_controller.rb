class VarientsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @varient.save
        format.html { redirect_to varient_url(@varient), notice: "Varient was successfully created." }
  ...
  def update
    respond_to do |format|
      if @varient.update(varient_params)
        format.html { redirect_to varient_url(@varient), notice: "Varient was successfully updated." }
